...
import DeGabrielDEVCurriculum from "assets/DeGabrielDEV_CV.pdf";
      ...
      <Container id="Curriculum">
        ...
        <section className="curriculum">
          <div className="content">
            <h1>Desbrave meu universo profissional! 🌟</h1>
            <p>
              Para uma análise minuciosa de minha trajetória, disponibilizo meu
