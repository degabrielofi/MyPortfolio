...
import iconStudio from "assets/images/iconStudio.png";
...
const Footer = ({ pageHome }) => {
  ...
  const handleScrollToHome = () => scrollTo("#Home");
  const handleScrollToAbout = () => scrollTo("#About");
  const handleScrollToTech = () => scrollTo("#Technologies");
  const handleScrollToCurriculum = () => scrollTo("#Curriculum");
  const handleScrollToPortfolio = () => scrollTo("#Portfolio");
  const handleScrollToFooter = () => scrollTo("#Footer");
  const handleScrollToEcosystem = () => scrollTo("#Ecosystem");
  ...
  async function sendEmail(e) {
    ...
    setLoading(true);
    try {
      await api.post("/contact", { name, email, phone, subject, comment });
          ...
          <form onSubmit={sendEmail}>
            ...
            <div className="message">
              <textarea
                ...
                required
              ></textarea>
              <i className="textInput fas fa-comment-alt"></i>
            </div>
        ...
        <footer style={{ background: "#fff" }}>
          <section className="container">
            <div className="content">
                ...
                <nav>
                  <ul>
                    ...
                    <li>
                      ...
                      <a
                        href="https://www.youtube.com/@degabrielofi"
                        target="_blank"
                        rel="noreferrer"
                      >
                        YouTube
                    ...
                    <li>
                      ...
                      <a
                        href="mailto:contato@degabrielofi.com.com"
                        target="_blank"
                        rel="noreferrer"
                      >
                        E-mail
              ...
              {/* bottom bar sem Bootstrap */}
              <section className="footerBottom">
                <div className="copy">
                  © {currentDate} Gabriel Pereira — Guebly
                </div>

                <a
                  className="studioCredit"
                  href="https://studio.guebly.com.br"
                  target="_blank"
                  rel="noreferrer"
                  title="Desenvolvido por Guebly Studio"
                >
                  <img src={iconStudio} alt="Guebly Studio" />
                  <span>Desenvolvido por Guebly Studio</span>
                </a>
              </section>
            </div>
          </section>
