      ...
      <Container className="relative z-[2] w-full pt-[clamp(100px,14vh,160px)]">
        ...
        <div style={{ marginTop: 48, paddingTop: 18, borderTop: '1px solid var(--color-bdr)', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 12, opacity: 0, animation: 'fadeIn .6s 3.5s forwards' }}>
          <div>
            ...
            <div style={{ fontSize: 11, color: 'var(--color-tx4)', marginTop: 4, display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{ fontFamily: 'var(--font-newsreader)', fontWeight: 300, fontSize: 13, letterSpacing: '0.04em', lineHeight: 1 }}>
                <span style={{ color: '#c4a96e' }}>de</span><span style={{ color: 'var(--color-tx)', opacity: 0.85 }}>Gabriel</span>
              </span>
              <span style={{ color: 'var(--color-bdr)' }}>·</span>
              <a href="https://instagram.com/degabrielofi_" target="_blank" className="font-mono" style={{ fontSize: 11, color: 'var(--color-ac)' }}>@degabrielofi_</a>
              <span className="font-mono">{t('allNetworks')}</span>
            </div>
          </div>
